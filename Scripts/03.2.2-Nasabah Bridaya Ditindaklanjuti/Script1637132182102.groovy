...
WebUI.click(findTestObject('Nasabah Bridaya Page/02.Nasabah Bridaya-Ditindaklanjuti/Button_Ditindaklanjuti'))

WebUI.verifyElementPresent(findTestObject('Nasabah Bridaya Page/02.Nasabah Bridaya-Ditindaklanjuti/Input_Cari Nama Ditindaklanjuti'), 
    0)

WebUI.verifyElementPresent(findTestObject('Nasabah Bridaya Page/02.Nasabah Bridaya-Ditindaklanjuti/Button_Search Ditindaklanjuti'), 
    0)
